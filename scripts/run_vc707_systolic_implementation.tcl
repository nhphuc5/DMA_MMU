# Full post-route verification and bitstream generation for the VC707 SoC
# booting the systolic-array demonstration firmware.
set script_dir [file dirname [file normalize [info script]]]
set root_dir   [file normalize [file join $script_dir ".."]]
set project_dir [file join $root_dir "build/vivado/vc707_systolic"]
set xpr_file [file join $project_dir \
    "DMA_IOMMU_PicoRV32_VC707_Systolic.xpr"]
...
if {![string match "*Complete*" [get_property STATUS [get_runs synth_1]]]} {
    error "Systolic VC707 synthesis failed; inspect synth_1/runme.log"
}
...
if {![string match "*Complete*" [get_property STATUS [get_runs impl_1]]]} {
    error "Systolic VC707 implementation failed; inspect impl_1/runme.log"
}

open_run impl_1
set report_dir [file join $root_dir "reports/vc707_systolic"]
set bit_dir [file join $root_dir "bitstream"]
file mkdir $report_dir
file mkdir $bit_dir
report_utilization -hierarchical -file \
    [file join $report_dir "vc707_systolic_utilization.rpt"]
report_timing_summary -delay_type min_max -report_unconstrained \
    -check_timing_verbose -file \
    [file join $report_dir "vc707_systolic_timing.rpt"]
report_drc -file [file join $report_dir "vc707_systolic_drc.rpt"]
...
set fd [open [file join $report_dir "vc707_systolic_fmax.txt"] w]
puts $fd "VC707 PicoRV32 + DMA/IOMMU + 4x4 systolic implementation"
...
set final_bit [file join $bit_dir \
    "DMA_IOMMU_PicoRV32_VC707_Systolic.bit"]
file copy -force $generated_bit $final_bit

if {$setup_wns < 0.0} {
    error "Systolic VC707 routed but failed timing: WNS=$setup_wns ns"
}
puts [format "SYSTOLIC VC707 PASSED: WNS %.3f ns; estimated Fmax %.3f MHz" \
