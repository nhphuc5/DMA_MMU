...
| Evidence | Result |
|---|---|
| `vc707_ddr3_build_summary.txt` | Synthesis and bitstream complete, WNS +0.041 ns, WHS +0.052 ns, DRC 0, DSP 0 |
| `vc707_ddr3_timing.rpt` | All user timing constraints met |
| `vc707_ddr3_utilization.rpt` | 39,087 LUT, 60,379 registers, 64 BRAM tiles, 0 DSP |
...
| `vc707_unified_fmax.txt` | Slack-equivalent Fmax estimate 150.921 MHz |
...
FCE4B5796EA66171B22B041EDE14978DB470B18F207D786B93D72B821A6AFE26
```
